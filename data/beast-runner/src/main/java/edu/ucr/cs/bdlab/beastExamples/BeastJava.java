...
public class BeastJava {
  public static void main(String[] args) throws IOException {
    ...
    String[] vectorSets = { "/data/testdata/vector/ne_10m_admin_0_countries.zip",
        "/data/testdata/vector/ne_10m_admin_0_countries.zip", "/data/testdata/vector/cb_2018_us_state_500k.zip" };
